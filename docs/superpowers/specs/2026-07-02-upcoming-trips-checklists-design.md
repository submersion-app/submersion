...
## Data Model (schema v97 → v98)

(originally planned as v95; renumbered as parallel branches each consumed a
version — dive naming v95, photo markers v96, multi-computer consolidation
v97 — landing on v98)
...
- Migration v98: create tables + indexes on `trip_checklist_items(trip_id)`
...
- Migration test: v97 → v98 tables + indexes.
