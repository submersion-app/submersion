...
void main() {
  group('DiveDetailSectionsPage', () {
    testWidgets('renders all 21 section names', (tester) async {
    ...
    testWidgets('renders 21 switches', (tester) async {
      await tester.binding.setSurfaceSize(const Size(400, 4000));
      addTearDown(() => tester.binding.setSurfaceSize(null));
      ...
      expect(find.byType(Switch), findsNWidgets(21));
    });
    ...
    testWidgets('renders drag handles', (tester) async {
      ...
      expect(find.byIcon(Icons.drag_handle), findsNWidgets(21));
    });
