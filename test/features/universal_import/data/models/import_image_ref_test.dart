...
void main() {
  group('ImportImageRef', () {
    ...
    test('value equality holds for identical fields and differs otherwise', () {
      const a = ImportImageRef(
        originalPath: 'a.jpg',
        diveSourceUuid: 'd',
        caption: 'c',
        position: 1,
      ...
      const different = ImportImageRef(
        originalPath: 'a.jpg',
        diveSourceUuid: 'OTHER',
      );
      expect(a, b);
