...
void main() {
  ...
  tearDown(() async {
    InsightsRepository.seriesDiveChunkSize =
        InsightsRepository.defaultSeriesDiveChunkSize;
  ...
  test('time at depth is the same however the dives are chunked', () async {
    ...
    InsightsRepository.seriesDiveChunkSize = 2;
  ...
  test(
    ...
    () async {
      ...
      InsightsRepository.seriesDiveChunkSize = 1;
