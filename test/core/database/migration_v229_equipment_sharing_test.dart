...
/// Schema v229: equipment sharing (issue #2046).
void main() {
  /// A v228 database without the sharing tables. Minimal parents, as the
  /// v219 fixture: the beforeOpen backstops heal every older rung.
  NativeDatabase setupDb({int userVersion = 228, bool withEquipment = true}) {
  ...
  test(
    'a database stamped v229 without the schema heals in beforeOpen',
    () async {
