...
void main() {
  test('v138 is the current schema version (exact-latest tripwire)', () {
    expect(AppDatabase.currentSchemaVersion, 138);
  ...
  test(
    'a database stranded before v138 gains diver_id via beforeOpen',
    () async {
