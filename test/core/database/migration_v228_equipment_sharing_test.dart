...
/// Schema v228: equipment sharing (issue #2046).
void main() {
  /// A v227 database without the sharing tables. Minimal parents, as the
  ...
  test(
    'a database stamped v228 without the schema heals in beforeOpen',
    () async {
