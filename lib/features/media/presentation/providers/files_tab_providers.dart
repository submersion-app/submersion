...
class FilesTabNotifier extends StateNotifier<FilesTabState> {
  ...
  /// Shared persistence path for `localFile` media. Built from this
  /// notifier's deps so Files-tab photos and imported photos go through the
  /// exact same write logic (bookmark / URI / localPath + MediaItem build).
