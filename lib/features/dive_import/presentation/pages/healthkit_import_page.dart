...
class HealthKitImportPage extends ConsumerStatefulWidget {
  const HealthKitImportPage({super.key});

  @override
  ConsumerState<HealthKitImportPage> createState() =>
      _HealthKitImportPageState();
}

class _HealthKitImportPageState extends ConsumerState<HealthKitImportPage> {
  int _currentStep = 0;
  ...
  Widget _buildBody(BuildContext context) {
    final hasPermissions = ref.watch(healthImportHasPermissionsProvider);
  ...
  Future<void> _requestPermissions() async {
    final notifier = ref.read(healthKitImportProvider.notifier);
    ...
    if (granted) {
      ...
      ref.invalidate(healthImportHasPermissionsProvider);
    }
  }
  ...
  Widget _buildStepSelectDives(BuildContext context) {
    final importState = ref.watch(healthKitImportProvider);
