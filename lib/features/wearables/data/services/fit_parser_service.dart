...
/// Parses Garmin FIT binary files into [WearableDive] entities.
///
...
class FitParserService {
  ...
  Future<List<WearableDive>> parseFitFiles(
    List<Uint8List> fileBytes, {
    List<String>? fileNames,
  }) async {
    final results = <WearableDive>[];
  ...
  List<WearableProfileSample> _buildProfile(
