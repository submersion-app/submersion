...
depth: maximum depth of the dive. avgDepth: average depth. bottomTime: minutes of bottom time. waterTemp: water temperature. airTemp: air temperature. visibility: underwater visibility distance. rating: 1 to 5 stars. o2: oxygen percent of the gas. diveNumber: the dive's number. waterType: salt, fresh or brackish. diveMode: oc, ccr, scr or gauge. entryMethod: shore, boat, backRoll, giantStride, seatedEntry, ladder, platform, jetty or other. currentStrength: none, light, moderate or strong. favorite: true. deco: true or false. noBuddy: true. weekday: mon, tue, wed, thu, fri, sat, sun. diveType: the name of a dive type. sacTrend: whether the diver's gas consumption rose, fell or stayed level through the dive, one of rising, falling or flat. sacRoseAfter: gas consumption rose after this many minutes into the dive. finalStopUnstable: true when the diver could not hold the last safety or decompression stop steady. finalStopDuration: how many minutes the last stop lasted. safetyFinding: one or more of rapidAscent, missedDecoStop, omittedSafetyStop, sawtoothProfile, highSurfaceGf.
...
{"schemaVersion":$kQuerySchemaVersion,"subject":"dives","clauses":[{"field":"waterTemp","op":"lt","value":15,"unit":"c","text":"cold-water"},{"field":"sacRoseAfter","op":"eq","value":20,"unit":"min","text":"SAC increased after 20 minutes"},{"field":"finalStopUnstable","op":"eq","value":true,"text":"the final stop was unstable"}],"mentions":[{"kind":"gear","text":"trilaminate suit"}],"time":null,"unplaced":[]}

Example 2b
Sentence: dives where I rushed the ascent and my air use kept climbing
{"schemaVersion":$kQuerySchemaVersion,"subject":"dives","clauses":[{"field":"safetyFinding","op":"eq","value":"rapidAscent","text":"I rushed the ascent"},{"field":"sacTrend","op":"eq","value":"rising","text":"my air use kept climbing"}],"mentions":[],"time":null,"unplaced":[]}
