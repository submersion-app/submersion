...
final insightsFilteredDiveIdsProvider = FutureProvider<Set<String>?>((
  ref,
) async {
  final filter = ref.watch(insightsFilterProvider);
  final statistics = ref.watch(insightsRepositoryProvider);
  ...
  ref.invalidateSelfWhen(statistics.watchInsightsChanges());
...
final exposureRankingProvider =
    FutureProvider.family<List<RankingItem>, Locale>((ref, locale) async {
      ...
      final keep = await ref.watch(insightsFilteredDiveIdsProvider.future);
