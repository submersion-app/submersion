...
final insightsGasLaneOverrideProvider = StateProvider<GasConsumptionLane?>(
  (ref) => null,
);
...
final insightsGasLaneProvider = Provider<GasConsumptionLane>((ref) {
  final display = ref.watch(gasConsumptionDisplayProvider);
  final override = ref.watch(insightsGasLaneOverrideProvider);
