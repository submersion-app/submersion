...
import 'package:submersion/features/insights/presentation/providers/equipment_condition_insights_providers.dart';
...
class InsightsEquipmentPage extends ConsumerWidget {
  final bool embedded;

  const InsightsEquipmentPage({super.key, this.embedded = false});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(context.l10n.insights_equipment_appBar_title),
  ...
  Widget _buildMostUsedGearSection(BuildContext context, WidgetRef ref) {
    ...
    return StatSectionCard(
      title: context.l10n.insights_equipment_mostUsedGear_title,
      subtitle: context.l10n.insights_equipment_mostUsedGear_subtitle,
      child: gearAsync.when(
        ...
        error: (_, _) => StatEmptyState(
          ...
          message: context.l10n.insights_equipment_mostUsedGear_error,
        ),
      ),
    );
  }
  ...
  Widget _buildExposureSection(BuildContext context, WidgetRef ref) {
    ...
    return StatSectionCard(
      title: l10n.insights_equipment_exposure_title,
      subtitle: l10n.insights_equipment_exposure_subtitle,
      ...
      child: rankingAsync.when(
        data: (data) => data.isEmpty
            ? StatEmptyState(
                icon: Icons.waves,
                message: l10n.insights_equipment_exposure_empty,
              )
            : RankingList(
                items: data,
        ...
        error: (_, _) => StatEmptyState(
          icon: Icons.error_outline,
          message: l10n.insights_equipment_exposure_error,
        ),
      ),
    );
  }
  ...
  Widget _buildFindingsSection(BuildContext context, WidgetRef ref) {
    ...
    return _rankingSection(
      ...
      title: l10n.insights_equipment_findings_title,
      // A finding is the gear's state now, not a set of dives, so the
      // filter that narrows the other cards cannot narrow this one.
      subtitle: ref.watch(insightsFilterProvider).hasActiveFilters
          ? l10n.insights_equipment_findings_subtitleAllDives
          : l10n.insights_equipment_findings_subtitle,
      countLabel: l10n.insights_equipment_countLabel_findings,
      empty: l10n.insights_equipment_findings_empty,
      error: l10n.insights_equipment_findings_error,
  ...
  Widget _buildIssuesSection(BuildContext context, WidgetRef ref) {
    ...
    return _rankingSection(
      ...
      title: l10n.insights_equipment_issues_title,
      subtitle: l10n.insights_equipment_issues_subtitle,
      countLabel: l10n.insights_equipment_countLabel_reports,
      empty: l10n.insights_equipment_issues_empty,
      error: l10n.insights_equipment_issues_error,
  ...
  String _unitLabel(AppLocalizations l10n, ExposureUnit unit) => switch (unit) {
    ExposureUnit.hours => l10n.insights_equipment_exposureUnit_hours,
    ExposureUnit.saltHours => l10n.insights_equipment_exposureUnit_saltHours,
    ExposureUnit.coldDives => l10n.insights_equipment_exposureUnit_coldDives,
    ExposureUnit.o2Hours => l10n.insights_equipment_exposureUnit_o2Hours,
    ExposureUnit.deepCycles => l10n.insights_equipment_exposureUnit_deepCycles,
    ExposureUnit.cycles => l10n.insights_equipment_exposureUnit_cycles,
    ExposureUnit.days => l10n.insights_equipment_exposureUnit_days,
    ExposureUnit.dives => l10n.insights_equipment_exposureUnit_dives,
  };
  ...
  String _countLabel(AppLocalizations l10n, ExposureUnit unit) =>
      switch (unit) {
        ExposureUnit.hours => l10n.insights_equipment_countLabel_hours,
        ExposureUnit.saltHours => l10n.insights_equipment_countLabel_saltHours,
        ExposureUnit.coldDives => l10n.insights_equipment_countLabel_coldDives,
        ExposureUnit.o2Hours => l10n.insights_equipment_countLabel_o2Hours,
        ExposureUnit.deepCycles =>
          l10n.insights_equipment_countLabel_deepCycles,
        ExposureUnit.cycles => l10n.insights_equipment_countLabel_cycles,
        ExposureUnit.days => l10n.insights_equipment_countLabel_days,
        ExposureUnit.dives => l10n.insights_equipment_countLabel_dives,
      };
  ...
  Widget _buildWeightTrendSection(
    ...
    return TrendChartSection(
      ...
      title: context.l10n.insights_equipment_weightTrend_title,
      subtitle: context.l10n.insights_equipment_weightTrend_subtitle,
      pointsAsync: ref.watch(weightTrendProvider),
      errorMessage: context.l10n.insights_equipment_weightTrend_error,
