...
///
/// Always rendered, even with a single profile: the switcher sheet it opens
/// offers "Add New Diver", so a tap is never a dead end. A small swap badge
/// marks it as a control rather than decoration, but only once a second
/// profile exists; with one profile there is nothing to swap to.
