...
final bluetoothConnectionManagerProvider =
    Provider<BluetoothConnectionManager>((ref) {
...
final bluetoothAvailabilityProvider =
    FutureProvider<BluetoothAvailability>((ref) async {
